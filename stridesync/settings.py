"""
Django settings for stridesync project.
...
SECRET_KEY = 'django-insecure-9_(otw)8cbn_k8=mak2)vkfjy9(wfc(hf2u9j9^lw^(*v7ie6!'
...
WSGI_APPLICATION = 'stridesync.wsgi.application'
